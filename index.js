...
app.use('/evaluations',require('./routes/evaluationsRouter')); // 콘텐츠 평가 및 취소

///-- GET --/
//app.use('/profiles/:userldx'); // 회원 전체 프로필 조회
app.use('/likes',require('./routes/likeRouter')); // 내가 찜한 콘텐츠 조회 
app.use('/searches',require('./routes/searchrouter')); // 최다 검색 조회
app.use('/categories',require('./routes/categoriesRouter')); // 메인 카테고리 조회
app.use('/categories',require('./routes/categoriesRouter')); //  시리즈 카테고리 조회
app.use('/categories',require('./routes/categoriesRouter')); // 영화 카테고리 조회 
